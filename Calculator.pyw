...
Button(frame_button, text='C', fg='black', width=56, height=3, bd=1, bg='#eee', cursor='hand2',
       command=lambda: clear()).grid(row=0, column=0, columnspan=3)

Button(frame_button, text='/', fg='black', width=20, height=3, bd=1, bg='#FFA500', cursor='hand2',
       command=lambda: click('/')).grid(row=0, column=3)

Button(frame_button, text='7', fg='black', width=18, height=3, bd=1, bg='#eee', cursor='hand2',
...
Button(frame_button, text='*', fg='black', width=20, height=3, bd=1, bg='#eee', cursor='hand2',
       command=lambda: click('*')).grid(row=1, column=3)

Button(frame_button, text='4', fg='black', width=18, height=3, bd=1, bg='#eee', cursor='hand2',
...
Button(frame_button, text='1', fg='black', width=18, height=3, bd=1, bg='#eee', cursor='hand2',
...
Button(frame_button, text='0', fg='black', width=37, height=3, bd=1, bg='#eee', cursor='hand2',
       command=lambda: click('0')).grid(row=4, column=0, columnspan=2)

Button(frame_button, text=',', fg='black', width=18, height=3, bd=1, bg='#eee', cursor='hand2',
